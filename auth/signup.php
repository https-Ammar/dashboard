...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        $message = "يجب أن تحتوي كلمة المرور على أحرف كبيرة وصغيرة وأرقام.";
            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div class="mb-5 sm:mb-8">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">أدخل معلوماتك لإنشاء حساب جديد!</p>
                    </div>
                    <div>
                        <?php if ($message): ?>
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="space-y-5">
                                <div>
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">اسم
                                        المستخدم</label>
                                ...
                                <div>
                                    <label
                                        class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">تأكيد
                                        كلمة المرور</label>
                                    <div x-data="{ showPassword: false }" class="relative">
                                        <input :type="showPassword ? 'text' : 'password'"
                                            placeholder="تأكيد كلمة المرور" type="password" name="confirm_password"
                                            required
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                        <span @click="showPassword = !showPassword"
                                            class="absolute top-1/2 right-4 z-30 -translate-y-1/2 cursor-pointer text-gray-500 dark:text-gray-400">
                                ...
                                <div>
                                    <button type="submit"
                                        class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 flex w-full items-center justify-center rounded-lg px-4 py-3 text-sm font-medium text-white transition">إنشاء
                                        حساب</button>
                                </div>
                            </div>
                        </form>
                        <div class="mt-5">
                            <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                لديك حساب بالفعل؟
                                <a href="./signin.php"
                                    class="text-brand-500 hover:text-brand-600 dark:text-brand-400">تسجيل الدخول</a>
                            </p>
                        </div>
                    </div>
                </div>
